...
You can link the CLI against a different version of the Y2 Go SDK
...
```bash
./scripts/link ../path/to/y2-go
```

If you run the link script without any arguments, it will default to `../y2-go`.
